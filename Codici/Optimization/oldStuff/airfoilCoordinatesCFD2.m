...
% x = [((0.4-0.2)*rand+0.2) ((0.9-0.4)*rand+0.4) 0 0 ((0.4-0.21)*rand+0.21) ((0.25-0.1)*rand+0.1) ((0.9-0.29)*rand+0.29) ((3-0.5)*rand+0.5)]
%((0.247+0.074)*rand-0.074) ((0.206+0.102)*rand-0.102)
% % c1 =  0.2;           % B[0.2, 0.4] 
% % c2 =  0.4;          % B[0.4, 0.9]  
% % c3 =  0;           % A[−0.074, 0.247] 
% % c4 =  0;           % A[−0.102, 0.206]
% % XT =  0.43;          % B[0.21, 0.4]  %aumentare max?
% % T =   0.25;        % B[0.07, 0.25]   % aumentato lo spessore minimo al 10% 
% % rho0_nd = 0.29;      % B[0.29, 0.9]
% % betaTE_nd = 0.5;    % B[0.5, 3]]

% x = [0.2 0.4 0 0 0.4 0.25 0.29 0.5];
% h_mesh = 0.002;
