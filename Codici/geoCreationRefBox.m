...
%% C-Grid data are given as INPUT to the function
    ...
    Href   = 15.*h;           % Dimension at refinement box boundary
    Rref   = 0.7;            % C-grid refinement box dimension
%--------------------------------------------------------------------------

%% Airfoil data import
data_airfoil = airfoilCoordinates(x, h);
%--------------------------------------------------------------------------
